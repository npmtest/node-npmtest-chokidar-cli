...
<div class="header medium">
    ...
    <h2>
        ...
        Statements: <span class="metric">59.65% <small>(34 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">60.71% <small>(34 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    ...
    watcher.on('all', <span class="fstat-no" title="function not covered" >function(event, path) {</span>
...
&nbsp;
    watcher.on('error', <span class="fstat-no" title="function not covered" >function(error) {</span>
...
&nbsp;
    watcher.once('ready', <span class="fstat-no" title="function not covered" >function() {</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (opts.ignore) <span class="cstat-no" title="statement not covered" >chokidarOpts.ignored = opts.ignore;</span>
&nbsp;
    return chokidarOpts;
}
&nbsp;
...
function _resolveIgnoreOpt(ignoreOpt) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!ignoreOpt) {
        return ignoreOpt;
    }
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Wed Apr 19 2017 02:35:30 GMT+0000 (UTC)</div>
</div>
</body>
</html>
